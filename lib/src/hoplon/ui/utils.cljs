...
(defn load-font [url]
  (.appendChild (.-documentElement js/document)
    (hoplon.core/link :href url :rel "preload" :as "font" :crossorigin true)))
...
(defn x     [e] (if-let [r (rect e)] (.-left   r) (nth e 0)))
(defn y     [e] (if-let [r (rect e)] (.-top    r) (nth e 1)))
